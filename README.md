...
日本進出したい海外ブランドと売れる販売パートナーをつなぐ BtoB マッチングサービスです。運営が仲介できる管理機能付きです。

## 機能

- 商品提供企業（内部 role: `maker`） / 販売パートナー / 管理者（`admin`）
- 公開プロフィール / プロフィール編集
...
| ロール | メール | パスワード |
|--------|--------|------------|
| 商品提供企業 | `maker1@demo.brandbridge.app` 〜 `maker5@...` | `DemoPass123!` |
